(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["demoBlockchain"] = factory();
	else
		root["demoBlockchain"] = factory();
})(this, function() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _blockchain = __webpack_require__(1);
	
	var demoChain = new _blockchain.Blockchain(); /* import { Blockchain, Transaction } from './demo-coin';
	                                              let demoChain = new Blockchain();
	                                              demoChain.createTransaction(new Transaction('address 1', 'address 2', 100)); */
	
	demoChain.addBlock(new _blockchain.Block(new Date(), { 'some': 'data' }));
	...
	new Vue({
	  ...
	  methods: {
	    ...
	    checkData: function checkData(event, index) {
	      ...
	      var valid = demoChain.checkBlockValid(index, value);
	
	      for (var i = index; i <= demoChain.chain.length - 1; i++) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SHA256 = __webpack_require__(2);
	...
	var Blockchain = exports.Blockchain = function () {
	  ...
	  _createClass(Blockchain, [{
	    ...
	    key: "checkBlockValid",
	    value: function checkBlockValid(index, data) {
	      var temp = this.chain[index].data;
	
	      if ((typeof temp === "undefined" ? "undefined" : _typeof(temp)) === 'object') temp = JSON.stringify(temp).replace(/\s/g, '');
